(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('commander'), require('fs'), require('path'), require('chalk'), require('log-utils'), require('lodash'), require('copy-dir'), require('mkdirp'), require('child_process'), require('app-root-path'), require('find-up')) :
    typeof define === 'function' && define.amd ? define(['commander', 'fs', 'path', 'chalk', 'log-utils', 'lodash', 'copy-dir', 'mkdirp', 'child_process', 'app-root-path', 'find-up'], factory) :
    (global = global || self, factory(global.commander, global.fs, global.path, global.chalk, global.logUtils, global.lodash, global.copyDir, global.mkdirp, global.childProcess, global.appRootPath, global.findUp));
}(this, (function (program, fs, path, chalk, logicon, _, copydir, mkdirp, child_process, APP_ROOT, findUp) {
