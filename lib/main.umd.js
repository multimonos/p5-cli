(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('commander'), require('fs'), require('path'), require('chalk'), require('log-utils'), require('lodash'), require('copy-dir'), require('mkdirp'), require('app-root-path')) :
    typeof define === 'function' && define.amd ? define(['commander', 'fs', 'path', 'chalk', 'log-utils', 'lodash', 'copy-dir', 'mkdirp', 'app-root-path'], factory) :
    (global = global || self, factory(global.commander, global.fs, global.path, global.chalk, global.logUtils, global.lodash, global.copyDir, global.mkdirp, global.appRootPath));
}(this, (function (program, fs, path, chalk, logicon, _, copydir, mkdirp, APP_PATH) {
