...
class ServeCommand extends Command {
  ...
  spawn(src) {
    ...
    const parcel = `${APP_ROOT__default['default']}/node_modules/.bin/parcel`; // necessary speed enhancement otherwise spawn is very very slow

    const cmd = child_process.spawn(`${parcel} ${src}`, {
      stdio: 'inherit',
      shell: true
    });
  }
